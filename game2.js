...
//	Crafty.canvas();
	...
	Crafty.scene("main", function() {
			...
			init: function () {
				...
				this.requires("SpriteAnimation, Collision")
					...
					.bind("EnterFrame", function() { 
						...
						//this is crude. it needs to tell them to go the opposite way they were going, case by case.
		...
		// Four chicken entities
		chicken1 = Crafty.e("2D, DOM, chicken, Animal, Solid")
			.attr({x: 100, y: 200})
