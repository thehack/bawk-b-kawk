...
//	Crafty.canvas();
	...
	function generateWorld() {
		...
		for(var i = 0; i < 47; i++) {
			...
			for(var j = 0; j < 20; j++) {
				...
				if(i > 0 && i < 46 && j > 0 && j < 19 && Crafty.randRange(0, 50) > 49) {
	...
	Crafty.scene("loading", function() {
		...
		Crafty.e("2D, DOM, Text").attr({w: 100, h: 20, x: 400, y: 190})
			.text("Loading")
	...
	Crafty.scene("main", function() {
		...
		player = Crafty.e("2D, DOM, player, Controls, CustomControls, Animate, Collision")
			.attr({x: 460, y: 190, z: 2})
			.CustomControls(1)
		...
		// create bullet componet
		bullet = Crafty.e("2D, DOM, bullet, Controls, CustomControls, Animate, Collision")
			.attr({x: player.x, y: player.y, z: 2})
